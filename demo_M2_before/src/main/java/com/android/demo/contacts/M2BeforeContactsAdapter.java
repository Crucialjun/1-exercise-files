 ...
 */
public class M2BeforeContactsAdapter extends RecyclerView.Adapter<M2BeforeContactsAdapter.ContactViewHolder> {
    ...
    public M2BeforeContactsAdapter(LayoutInflater layoutInflater, CallContact callContact) {
        mLi = layoutInflater;
