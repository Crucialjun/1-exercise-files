...
public class Module3UnhappyContactsActivity extends Module3BaseActivity {
    private Module3UnhappyContactsAdapter mAdapter;
    private RamRunnable mRamRunnable;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mAdapter = new Module3UnhappyContactsAdapter(this, this);
