 ...
 */
public class M3AfterContactsAdapter extends RecyclerView.Adapter<M3AfterContactsAdapter.ContactViewHolder> {
    ...
    public M3AfterContactsAdapter(Context activityContext, CallContact callContact) {
