 ...
 */
public class Module3UnhappyContactsAdapter extends RecyclerView.Adapter<Module3UnhappyContactsAdapter.ContactViewHolder> {
    ...
    public Module3UnhappyContactsAdapter(Context activityContext, CallContact callContact) {
