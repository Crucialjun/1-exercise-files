 ...
 */
public class M2AfterContactsAdapter extends RecyclerView.Adapter<M2AfterContactsAdapter.ContactViewHolder> {
    ...
    public M2AfterContactsAdapter(LayoutInflater layoutInflater, CallContact callContact) {
        mLi = layoutInflater;
