...
public class M3BeforeSensorService extends Service implements SensorEventListener {
    private static final String TAG =M3BeforeSensorService.class.getSimpleName();
